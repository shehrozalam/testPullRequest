...
#if __COVERITY__
#if !defined(COVERITY_COMPAT_6f0704c5dfc50405b3d5bac6f47943f5)
#define COVERITY_COMPAT_6f0704c5dfc50405b3d5bac6f47943f5
#pragma builtin begin

/*
  Copyright (c) 2019 Synopsys, Inc. All rights reserved worldwide.
...
__simd128_int32_t __builtin_neon_vcombinedi (int __a, int __b);
...
__simd128_int32_t __builtin_neon_vdup_nv16qi (__builtin_neon_qi __a);
__simd128_int32_t __builtin_neon_vdup_nv2di (__builtin_neon_di __a);
__simd128_int32_t __builtin_neon_vdup_nv4si (__builtin_neon_si __a);
__simd128_int32_t __builtin_neon_vdup_nv8hi (__builtin_neon_hi __a);
...
__simd128_int32_t __builtin_neon_vld1_dupv16qi (const __builtin_neon_qi *  __a);
__simd128_int32_t __builtin_neon_vld1_dupv2di (const __builtin_neon_di *  __a);
__simd128_int32_t __builtin_neon_vld1_dupv4si (const __builtin_neon_si *  __a);
__simd128_int32_t __builtin_neon_vld1_dupv8hi (const __builtin_neon_hi *  __a);
__simd128_int32_t __builtin_neon_vld1_lanev4si (const int * __a, __simd128_int32_t __b, const int __c);
__simd128_int32_t __builtin_neon_vld1v16qi (const __builtin_neon_qi *  __a);
__simd128_int32_t __builtin_neon_vld1v2di (const __builtin_neon_di *  __a);
__simd128_int32_t __builtin_neon_vld1v4si (const __builtin_neon_si *  __a);
__simd128_int32_t __builtin_neon_vld1v8hi (const __builtin_neon_hi *  __a);
...
__simd64_int32_t __builtin_neon_vcreatev4hi (__builtin_neon_di __a);
__simd64_int32_t __builtin_neon_vcreatev8qi (__builtin_neon_di __a);
...
__simd64_int32_t __builtin_neon_vdup_nv4hi (__builtin_neon_hi __a);
__simd64_int32_t __builtin_neon_vdup_nv8qi (__builtin_neon_qi __a);
...
__simd64_int32_t __builtin_neon_vld1_dupv4hi (const __builtin_neon_hi *  __a);
__simd64_int32_t __builtin_neon_vld1_dupv8qi (const __builtin_neon_qi *  __a);
...
__simd64_int32_t __builtin_neon_vld1v4hi (const __builtin_neon_hi *  __a);
__simd64_int32_t __builtin_neon_vld1v8qi (const __builtin_neon_qi *  __a);
...
#if __COVERITY_GCC_VERSION_AT_LEAST(8, 0) && !defined(__COVERITY_DISABLE_BUILTIN_DECLS)
/*
...
__float128 __builtin_nanq(const char*);
__float128 __builtin_nansq(const char*);
#endif

void __builtin_ia32_ptwrite32(unsigned int);
void __builtin_ia32_ptwrite64(long long unsigned int);
...
#endif
long int __builtin_expect_with_probability(long int, long int, double);
...
__cov_v2df __builtin_ia32_loadsd_mask(const double*, __cov_v2df, unsigned char);
__cov_v4sf __builtin_ia32_loadss_mask(const float*, __cov_v4sf, unsigned char);
__cov_v2df __builtin_ia32_movesd_mask(__cov_v2df, __cov_v2df, __cov_v2df, unsigned char);
__cov_v4sf __builtin_ia32_movess_mask(__cov_v4sf, __cov_v4sf, __cov_v4sf, unsigned char);
void __builtin_ia32_storesd_mask(double*, __cov_v2df, unsigned char);
void __builtin_ia32_storess_mask(float*, __cov_v4sf, unsigned char);
__cov_v2df __builtin_ia32_vfmaddsd3_mask(__cov_v2df, __cov_v2df, __cov_v2df, unsigned char, int);
__cov_v2df __builtin_ia32_vfmaddsd3_mask3(__cov_v2df, __cov_v2df, __cov_v2df, unsigned char, int);
__cov_v2df __builtin_ia32_vfmaddsd3_maskz(__cov_v2df, __cov_v2df, __cov_v2df, unsigned char, int);
__cov_v4sf __builtin_ia32_vfmaddss3_mask(__cov_v4sf, __cov_v4sf, __cov_v4sf, unsigned char, int);
__cov_v4sf __builtin_ia32_vfmaddss3_mask3(__cov_v4sf, __cov_v4sf, __cov_v4sf, unsigned char, int);
__cov_v4sf __builtin_ia32_vfmaddss3_maskz(__cov_v4sf, __cov_v4sf, __cov_v4sf, unsigned char, int);
__cov_v8df __builtin_ia32_vfmsubpd512_mask(__cov_v8df, __cov_v8df, __cov_v8df, unsigned char, int);
__cov_v8df __builtin_ia32_vfmsubpd512_maskz(__cov_v8df, __cov_v8df, __cov_v8df, unsigned char, int);
__cov_v16sf __builtin_ia32_vfmsubps512_mask(__cov_v16sf, __cov_v16sf, __cov_v16sf, short int, int);
__cov_v16sf __builtin_ia32_vfmsubps512_maskz(__cov_v16sf, __cov_v16sf, __cov_v16sf, short int, int);
__cov_v2df __builtin_ia32_vfmsubsd3_mask3(__cov_v2df, __cov_v2df, __cov_v2df, unsigned char, int);
__cov_v4sf __builtin_ia32_vfmsubss3_mask3(__cov_v4sf, __cov_v4sf, __cov_v4sf, unsigned char, int);
__cov_v8df __builtin_ia32_vfnmaddpd512_mask3(__cov_v8df, __cov_v8df, __cov_v8df, unsigned char, int);
__cov_v8df __builtin_ia32_vfnmaddpd512_maskz(__cov_v8df, __cov_v8df, __cov_v8df, unsigned char, int);
__cov_v16sf __builtin_ia32_vfnmaddps512_mask3(__cov_v16sf, __cov_v16sf, __cov_v16sf, short int, int);
__cov_v16sf __builtin_ia32_vfnmaddps512_maskz(__cov_v16sf, __cov_v16sf, __cov_v16sf, short int, int);
__cov_v8df __builtin_ia32_vfnmsubpd512_maskz(__cov_v8df, __cov_v8df, __cov_v8df, unsigned char, int);
__cov_v16sf __builtin_ia32_vfnmsubps512_maskz(__cov_v16sf, __cov_v16sf, __cov_v16sf, short int, int);
unsigned char __builtin_ia32_tpause(unsigned int, long long unsigned int);
void __builtin_ia32_umonitor(void*);
unsigned char __builtin_ia32_umwait(unsigned int, long long unsigned int);
__cov_v2df __builtin_ia32_vfmsubpd128_mask(__cov_v2df, __cov_v2df, __cov_v2df, unsigned char);
__cov_v2df __builtin_ia32_vfmsubpd128_maskz(__cov_v2df, __cov_v2df, __cov_v2df, unsigned char);
__cov_v4df __builtin_ia32_vfmsubpd256_mask(__cov_v4df, __cov_v4df, __cov_v4df, unsigned char);
__cov_v4df __builtin_ia32_vfmsubpd256_maskz(__cov_v4df, __cov_v4df, __cov_v4df, unsigned char);
__cov_v4sf __builtin_ia32_vfmsubps128_mask(__cov_v4sf, __cov_v4sf, __cov_v4sf, unsigned char);
__cov_v4sf __builtin_ia32_vfmsubps128_maskz(__cov_v4sf, __cov_v4sf, __cov_v4sf, unsigned char);
__cov_v8sf __builtin_ia32_vfmsubps256_mask(__cov_v8sf, __cov_v8sf, __cov_v8sf, unsigned char);
__cov_v8sf __builtin_ia32_vfmsubps256_maskz(__cov_v8sf, __cov_v8sf, __cov_v8sf, unsigned char);
__cov_v2df __builtin_ia32_vfnmaddpd128_mask3(__cov_v2df, __cov_v2df, __cov_v2df, unsigned char);
__cov_v2df __builtin_ia32_vfnmaddpd128_maskz(__cov_v2df, __cov_v2df, __cov_v2df, unsigned char);
__cov_v4df __builtin_ia32_vfnmaddpd256_mask3(__cov_v4df, __cov_v4df, __cov_v4df, unsigned char);
__cov_v4df __builtin_ia32_vfnmaddpd256_maskz(__cov_v4df, __cov_v4df, __cov_v4df, unsigned char);
__cov_v4sf __builtin_ia32_vfnmaddps128_mask3(__cov_v4sf, __cov_v4sf, __cov_v4sf, unsigned char);
__cov_v4sf __builtin_ia32_vfnmaddps128_maskz(__cov_v4sf, __cov_v4sf, __cov_v4sf, unsigned char);
__cov_v8sf __builtin_ia32_vfnmaddps256_mask3(__cov_v8sf, __cov_v8sf, __cov_v8sf, unsigned char);
__cov_v8sf __builtin_ia32_vfnmaddps256_maskz(__cov_v8sf, __cov_v8sf, __cov_v8sf, unsigned char);
__cov_v2df __builtin_ia32_vfnmsubpd128_maskz(__cov_v2df, __cov_v2df, __cov_v2df, unsigned char);
__cov_v4df __builtin_ia32_vfnmsubpd256_maskz(__cov_v4df, __cov_v4df, __cov_v4df, unsigned char);
__cov_v4sf __builtin_ia32_vfnmsubps128_maskz(__cov_v4sf, __cov_v4sf, __cov_v4sf, unsigned char);
__cov_v8sf __builtin_ia32_vfnmsubps256_maskz(__cov_v8sf, __cov_v8sf, __cov_v8sf, unsigned char);
__cov_v2df __builtin_ia32_vfmsubsd3(__cov_v2df, __cov_v2df, __cov_v2df);
__cov_v4sf __builtin_ia32_vfmsubss3(__cov_v4sf, __cov_v4sf, __cov_v4sf);
__cov_v2df __builtin_ia32_vfnmaddsd3(__cov_v2df, __cov_v2df, __cov_v2df);
__cov_v4sf __builtin_ia32_vfnmaddss3(__cov_v4sf, __cov_v4sf, __cov_v4sf);
__cov_v2df __builtin_ia32_vfnmsubsd3(__cov_v2df, __cov_v2df, __cov_v2df);
__cov_v4sf __builtin_ia32_vfnmsubss3(__cov_v4sf, __cov_v4sf, __cov_v4sf);

#if __COVERITY_GCC_VERSION_AT_LEAST(9, 0)
/*
 * EDG 5.0 does not yet include prototypes for GCC 9 builtins, so these are
 * enabled even when __COVERITY_DISABLE_BUILTIN_DECLS is set.
 */
...
//-mfma4
__cov_v4sf __builtin_ia32_vfmsubps(__cov_v4sf, __cov_v4sf, __cov_v4sf);
__cov_v2df __builtin_ia32_vfmsubpd(__cov_v2df, __cov_v2df, __cov_v2df);
__cov_v4sf __builtin_ia32_vfnmaddps(__cov_v4sf, __cov_v4sf, __cov_v4sf);
__cov_v2df __builtin_ia32_vfnmaddpd(__cov_v2df, __cov_v2df, __cov_v2df);
__cov_v4sf __builtin_ia32_vfnmsubps(__cov_v4sf, __cov_v4sf, __cov_v4sf);
__cov_v2df __builtin_ia32_vfnmsubpd(__cov_v2df, __cov_v2df, __cov_v2df);
__cov_v8sf __builtin_ia32_vfmsubps256(__cov_v8sf, __cov_v8sf, __cov_v8sf);
__cov_v4df __builtin_ia32_vfmsubpd256(__cov_v4df, __cov_v4df, __cov_v4df);
__cov_v8sf __builtin_ia32_vfnmaddps256(__cov_v8sf, __cov_v8sf, __cov_v8sf);
__cov_v4df __builtin_ia32_vfnmaddpd256(__cov_v4df, __cov_v4df, __cov_v4df);
__cov_v8sf __builtin_ia32_vfnmsubps256(__cov_v8sf, __cov_v8sf, __cov_v8sf);
__cov_v4df __builtin_ia32_vfnmsubpd256(__cov_v4df, __cov_v4df, __cov_v4df);

#define __builtin_speculation_safe_value(t1, t2) t1
#endif

#if __COVERITY_GCC_VERSION_AT_LEAST(9, 2)
...
#define __builtin_convertvector(vec, vectype) vectype

__float128 __builtin_sqrtf128(__float128);
__float128 __builtin_fmaf128(__float128, __float128, __float128);
__float128 __builtin_fmaxf128(__float128, __float128);
__float128 __builtin_fminf128(__float128, __float128);
...
#pragma builtin end
#endif /* COVERITY_COMPAT_6f0704c5dfc50405b3d5bac6f47943f5 */
#endif /* __COVERITY__ */
